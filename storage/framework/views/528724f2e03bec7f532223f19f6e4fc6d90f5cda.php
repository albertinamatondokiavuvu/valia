                  ...
                  <div class="col-lg-6">
                    <div class="card-body p-md-5 mx-md-4">
                      ...
                      <form method="POST" action="<?php echo e(route('register')); ?>">
                        <?php echo csrf_field(); ?>
                        <p>Por favor, Preenche o formulário a baixo para se cadastrar</p>

                        <div class="form-outline mb-4">
                          <input id="name" type="name" id="form2Example11" class="form-control <?php $__errorArgs = ['name'];
...
unset($__errorArgs, $__bag); ?>" name="password" required autocomplete="new-password" placeholder="palavra-passe" />
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-outline mb-4">
                            <input id="password" type="password" id="form2Example22" class="form-control " name="password_confirmation" required autocomplete="new-password" placeholder="Confirmar a palavra-passe" />
                          </div>

                        <div class="text-center pt-1 mb-5 pb-1">
                          <button class="btn btn-primary btn-block fa-lg gradient-custom-2 mb-3" type="submit">Confirmar
                            </button>
                        </div>
...
<?php /**PATH C:\Users\Albertina Kiavuvu\valia\resources\views/auth/register.blade.php ENDPATH**/ ?>