...
<div class="pcoded-content">
            ...
            <div class="row align-items-center">
                <div class="col-md-8">
                    <div class="page-header-title">
                        ...
                        <p class="m-b-0">Cadastre um evento ou uma notícia</p>
    ...
    <small style="text-align: left; font-weight:bold;">Campos com <small style="color: red;">*</small> são campos obrigatórios</small>
                ...
                <div class="card-block">
                    <!-- button Default -->
                    <form action="<?php echo e(route('storeupdate')); ?>" class="row" method="POST" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.layoutadmin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Albertina Kiavuvu\valia\resources\views/admin/update/create/index.blade.php ENDPATH**/ ?>