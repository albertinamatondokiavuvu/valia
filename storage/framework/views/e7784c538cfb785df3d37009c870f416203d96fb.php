...
<div class="pcoded-content">
    ...
    <small style="text-align: left; font-weight:bold;">Campos com <small style="color: red;">*</small> são campos obrigatórios</small>
                ...
                <div class="card-block">
                    <!-- button Default -->
                    <form action="<?php echo e(route('updategabarito',$gabaritos->id)); ?>" class="row" method="POST" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.layoutadmin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Albertina Kiavuvu\valia\resources\views/admin/gabarito/edit/index.blade.php ENDPATH**/ ?>