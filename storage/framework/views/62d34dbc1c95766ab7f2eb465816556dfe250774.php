                ...
                <div class="swiper-container">
                    ...
                    <div class="swiper-wrapper">
                        ...
                        <div class="swiper-slide">
                            <div class="col">
                                <div class="card" >
                                    <img class="card-img-top" src="/storage/<?php echo e($cursos->foto); ?>" alt="Card image cap">
                                    <div class="card-body">
                                      <h5 class="card-title"><?php echo e($cursos->curso); ?></h5>
                                      <p class="card-text">
                                        <span class="attached"><a target="_blank" href="/storage/<?php echo e($cursos->resumo); ?>"><i class="fas fa-paperclip"></i> Resumo do Curso</a></span>
                                      </p>
                ...
                <div class="row mt-1">
                    ...
                    <div class=" row col-lg-7 mt-5 mt-lg-0" data-aos="fade-left" data-aos-delay="100">
                        <div class="col-lg-8">
                            ...
                            <div class="row">
                                <div class="col-4">
                                   <img src="/storage/<?php echo e($updates->foto); ?>" alt="" class="card-img-top imgC" srcset="">
                                </div>
                                <div class="col-8">
                                    <?php
                                    ...
                                    <br>
                                  <a href="<?php echo e(route('updatesList',$updates->id)); ?>"> <strong><?php echo e($updates->titulo); ?></strong></a>
                                  <br>
                        ...
                        <div class="col-lg-4">
                            <img src="/storage/<?php echo e($gabaritos->capa); ?>" alt="" srcset="" class="card-img-top imgC1">
                            <p class="text-center"><?php echo e($gabaritos->titulo); ?></p>
                            <a  href="/storage/<?php echo e($gabaritos->documento); ?>" target="_blank" class="btn btn-primary center pl-4">baixar</a>
...
<?php echo $__env->make('layouts.site.header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\INADE 05\Documents\Projectos\valia\resources\views/site/welcome.blade.php ENDPATH**/ ?>