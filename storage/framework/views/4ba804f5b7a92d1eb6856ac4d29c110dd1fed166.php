...
<?php if(Auth::check()): ?>
                                ...
                                <form action="<?php echo e(route('storeBolsaFormadores')); ?>" class="row" method="POST" enctype="multipart/form-data">
                                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.site.header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\INADE 05\Documents\Projectos\valia\resources\views/site/bolsaFormadores\list/index.blade.php ENDPATH**/ ?>