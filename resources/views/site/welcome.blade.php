                                            ...
                                            <div class="position-relative mb-3 img-news border-top">
                                                <div class="bg-white border border-top-0 p-4" style="height: 150px;">
                                                    <div class="mb-2 rounded-0 rounded head-news">
                                                        ...
                                                        <span class="text-body text-secondary"><b>{{ date('d-m-Y', strtotime($cursos->created_at)) }}</b></span>
                                                    </div>
                                                    <span class="mb-3 text-uppercase font-weight-bold"
                                                        >{{ $cursos->curso }}</span>
                                                        <p class="m-0 text-secondary"> <a target="_blank"
                                                        href="/storage/{{ $cursos->resumo }}"><i class="fas fa-paperclip"></i>
                    ...
                    <div class=" row col-lg-7 mt-5 mt-lg-0" data-aos="fade-left" data-aos-delay="100">
                        <div class="col-lg-8">
                            @isset($updates)
                                ...
                                <div class="row">
                                    <div class="col-4">
                                        <img src="/storage/{{ $updates->foto }}" alt="" class="card-img-top imgC"
                                            srcset="">
                                    </div>
                                    <div class="col-8">
                                        <?php
                                        ...
                                        <a href="{{ route('updatesList', $updates->id) }}">
                                            <strong>{{ $updates->titulo }}</strong></a>
                            ...
                            <div class="col-lg-4">
                                ...
                                <div class="row">
                                            ...
                                            <div class="position-relative mb-3 img-news border-top">
                                                <img class="img-fluid w-100 border"
                                                    style="height: 250px; width: 100%; object-fit: cover"
                                                    src="/storage/{{ $gabaritos->capa }}">


                                                    <span class="mb-3 text-uppercase font-weight-bold"
                                                        >{{ $gabaritos->titulo }}</span>
                                                        <p class="m-0 text-secondary">  <a href="/storage/{{ $gabaritos->documento }}" target="_blank"
