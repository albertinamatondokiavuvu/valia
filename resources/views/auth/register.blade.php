                            ...
                            <div class="col-lg-6">
                                <div class="card-body p-md-5 mx-md-4">
                                    ...
                                    <div class="text-center">
                                        <a href="{{ route('site') }}">
                                            <img src="/img/logo/logoValia.png" style="width: 185px;" alt="logo"></a>
                                    ...
                                    <form method="POST" action="{{ route('register') }}">
                                        ...
                                        <div class="form-outline mb-4">
                                            <input id="name" type="name" id="form2Example11"
                                        ...
                                        <div class="form-outline mb-4">
                                            <input id="email" type="email" id="form2Example11"
                                        ...
                                        <div class="form-outline mb-4">
                                            <input id="password" type="password" id="form2Example22"
                                        ...
                                        <div class="form-outline mb-4">
                                            <input id="password" type="password" id="form2Example22"
                                                ...
                                                autocomplete="new-password" placeholder="Confirmar a palavra-passe" />
                                        </div>
